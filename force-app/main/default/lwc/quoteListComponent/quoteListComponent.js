...
const columns = [
    ...
    { label: 'Total Amount', fieldName: 'TotalPrice', type: 'currency' },
    {
        type: 'action',
...
export default class QuoteListComponent extends NavigationMixin(LightningElement) {
    @track allQuotes = [];
    ...
    filterQuotes() {
        ...
        if (this.searchKey) {
            filtered = filtered.filter(quote => 
                ...
                (quote.QuoteNumber && quote.QuoteNumber.toLowerCase().includes(this.searchKey))
            );
        }
